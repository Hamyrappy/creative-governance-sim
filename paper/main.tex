...
supplies a mechanism for the reported poor generalization of automatically evolved harnesses, and a
diagnostic that predicts the sign before the sweep is run.
