...
being told it does not do. We also report three validity gates that this study needed and failed
before it passed: output truncation correlated with the treatment, channels that delivered no signal,
and reference anchors superseded by a recalibration.
\end{enumerate}
