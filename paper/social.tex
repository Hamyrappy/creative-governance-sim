...
content moderation, a fishing community governing a stock by quota and reserve, a firm governing
...
advance, cheaply, without observing any government at all.
...
leaning altogether and hold a constant rate---an institution that abandons feedback. The clairvoyant
...
incumbent Taylor rule, which leans against inflation, instead sees prices drifting and raises rates.
...
restrictive stance long after restriction had stopped restricting anything. Its instructions stated,
at every review, that the rate's cost is charged ``whether or not the rate reaches the economy''. It
read that and leaned harder.
...
precedent, in the ordinary administrative sense. It is the channel one would expect to help most
across a structural break, since a break is exactly the situation in which the past is informative
...
So revision is not the good thing. What the memory channel removed was the \emph{capacity} for
revision---the institution stopped being the kind of thing that could change its mind---and that is
what cost it. Prescribing ``revise more often'' would be treating a symptom that is not, on its own,
the mechanism.
