...
Твоя второстепенная цель: Минимизировать "стоимость" управления. Показатель - средний квадрат управления (MSU) за последние {perf_window} шагов: MSU = mean(u_i^2) for i in [k-{perf_window}...k-1]. Старайся достичь низкой MSE, не допуская чрезмерно больших или резко колеблющихся значений `u_k`.
